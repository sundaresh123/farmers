														...
														<div class="col-md-6">
                                                            ...
                                                            <br>
															 <p>Date : <?php   echo date("m/d/Y", $date);?></p>
															  <?php  } ?> 
															 <form action="invoice_solar_print_1.php" method="post" target="_blank">
 
 													           <button type="submit" name="invoice_solar_print_1" class="btn btn-success btn-print-invoice m-b-10 btn-sm waves-effect waves-light m-r-20">Print</button>
													         </form> 
