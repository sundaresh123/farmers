								...
								<div class="row align-items-center">
									<div class="col-md-12">
										...
										<div class="page-header-title text-right">
											<a href="solar_display.php"><button class="btn btn-primary">View</button></a>
										</div>
										<ul class="breadcrumb">
													...
													<div class="card-block">
														<form method="post" action="process.php">
															...
															<div class="form-group row">
																...
																<div class="col-sm-10">
																	 <input type="text" id="saadhar" name="student_aadhar" placeholder=" Aadhar Number" class="form-control" required>
															...
															<div class="form-group row">
 															...
 															<div class="form-group row">
																...
																<div class="col-sm-10">
																	  <button type="submit" name="submit_2" class="btn btn-primary m-b-0">Register</button>
 																</div>
															</div>
														</form>
 													</div>
