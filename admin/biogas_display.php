													...
													<table id="dom-jqry" class="table table-striped table-bordered nowrap">
														...
														<tbody>
															...
															<tr>
																...
																<td>
																		 <form action="biogas_report_print.php" method="post" target="_blank">
																			...
																			<div class="modal-body">
																				<form role="form" method="post" action="process.php">
																					...
																					<div class="form-group col-md-12">
																						...
																						<input type="text"   class="form-control"  value="<?php echo $firstname;?>" name="firstname" id="exampleInput_13">
																					</div>  
																					<div class="form-group col-md-12">
																						<label for="exampleInput">Father Name</label>
																						<input type="text"   class="form-control"  value="<?php echo $father_name;?>" name="father_name" id="exampleInput_14">
																					</div> 
																					<div class="form-group col-md-12">
																						<label for="exampleInput"> Aadhar No</label>
																					...
																					<div class="form-group col-md-12">
																						...
																						<input type="text"   class="form-control"  value="<?php echo $contact;?>" name="contact" id="exampleInput_16">
																					</div>     
																					<div class="form-group col-md-12">
																						<label for="exampleInput">Address</label>
																						<input type="text"   class="form-control"  value="<?php echo $address;?>" name="address" id="exampleInput_17">
																					</div>
																					<div class="form-group col-md-12">
																						<label for="exampleInput">Amount</label>
																						<input type="text"   class="form-control"  value="<?php echo $amount;?>" name="amount" id="exampleInput_23" readonly>
																					</div> 
 																				</div>
																				<div class="modal-footer">
																					<button class="btn btn-success btn-ef btn-ef-3 btn-ef-3c" type="submit"  name="edit_biogas" ><i class="fa fa-refresh"></i> Update</button>
																					<button class="btn btn-danger btn-ef btn-ef-3 btn-ef-3c" type="submit"  name="delete_biogas" ><i class="fa fa-trash"></i> Delete</button>
																				</form> 
