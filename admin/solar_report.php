...
function showUser(str) {
  ...
  xmlhttp.open("GET","show_solar.php?q="+str,true);
  xmlhttp.send();
}
</script>
								...
								<div class="row align-items-center">
									<div class="col-md-12">
										<div class="page-header-title">
											<h4 class="m-b-10">Solar Reports</h4>
										</div>
										<br>
 										<ul class="breadcrumb">
															...
															<div class="row">
															 ...
															 <div class="form-group col-md-2">
                                                           	...
                                                           	<div class="form-group col-md-2">
																	...
																	<button type="submit" name="sales_report" style="margin-top:25px;" class="btn btn-primary" id="btn-submit_2">View</button>
																</div>  
																<!-- <div class="form-group col-md-2">
																	<label for="exampleInput"></label>
...
//  Report View
$('#btn-submit_2').click(function(){
  // alert('fddf'); student_report_display.php
  var from_date = $('.from_date').val();
  var to_date = $('.to_date').val();
  var firstname = $('.firstname').val();
	 $.ajax({
	    url:"solar_report_display.php",
	    method:"GET",
	    data:{
	        from_date:from_date,
	        to_date:to_date,
